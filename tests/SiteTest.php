...
class SiteTest extends TestCase
{
   ...
   $GLOBALS['app'] = new Src\Application(new Src\Settings([
       'app' => include $_SERVER['DOCUMENT_ROOT'] . '/mvc/config/app.php',
       'db' => include $_SERVER['DOCUMENT_ROOT'] . '/mvc/config/db.php',
       'path' => include $_SERVER['DOCUMENT_ROOT'] . '/mvc/config/path.php',
   ]));
